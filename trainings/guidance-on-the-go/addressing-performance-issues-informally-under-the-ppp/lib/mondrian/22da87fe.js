...
`;let Nn=class extends Go{constructor(){super(...arguments),this.selected=!1,this.tabIndex=-1,this.role="menuitem",this.delegatesFocus=!1,this.focusableRef=(0,Ln._)(),this.bindEvents=()=>{this.on("mouseenter",(()=>{this.dispatch("hover",{value:this.value,hovered:!0})})),this.on("click",this.onClick),this.on("focus",(()=>{if(this.delegatesFocus){const e=this.querySelector('a, button, input, textarea, select, details, [tabindex]:not([tabindex="-1"])');e instanceof HTMLElement&&e.focus()}}))}}onClick(){this.dispatch("mon-menu-item:select")}render(){return Ho.qy`
      <slot name="icon"></slot>
      <div class="content">
        <slot></slot>
        <div class="extras">
    ...
    `}};Nn.formAssociated=!0,Nn.styles=En,Nn.shadowRootOptions={...Ho.WF.shadowRootOptions,delegatesFocus:!1},(0,_o.Cg)([(0,qo.MZ)({type:String,reflect:!0})],Nn.prototype,"value",void 0),(0,_o.Cg)([(0,qo.MZ)({type:Boolean,reflect:!0})],Nn.prototype,"selected",void 0),(0,_o.Cg)([(0,qo.MZ)({type:Number,reflect:!0})],Nn.prototype,"tabIndex",void 0),(0,_o.Cg)([(0,qo.MZ)({type:String,reflect:!0})],Nn.prototype,"role",void 0),(0,_o.Cg)([(0,qo.MZ)()],Nn.prototype,"delegatesFocus",void 0),(0,_o.Cg)([(0,qo.wk)()],Nn.prototype,"focusableRef",void 0),Nn=(0,_o.Cg)([(0,qo.EM)("mon-menu-item")],Nn);const qn=Ho.AH`
  * {
    box-sizing: border-box;
  }
...
`;let tl=class extends Go{constructor(){super(...arguments),this.value=null,this.popoverPlacement="bottom-end",this.placeholder="Choose an item...",this.open=!1,this.labelText="",this.anchorRef=(0,Ln._)(),this.scrollBarWidth=nr,this.cancel=()=>{this.open&&(this.dispatch("mon-select:cancel"),this.dispatch("mon-select:close")),this.open=!1},this.onMenuEscape=()=>{this.cancel()},this.onSubmit=e=>{this.open=!1,e.stopPropagation(),this.dispatch("mon-select:close"),this.dispatch("mon-select:change",{name:this.name,value:e.detail.value})},this.onClickOutside=()=>{this.cancel()},this.onClickTrigger=()=>{this.open?this.cancel():(this.open=!0,this.dispatch("mon-select:open"))},this.onKeyDown=e=>{"ArrowLeft"===e.key&&e.stopPropagation()},this.onButtonKeyDown=e=>{"Enter"===e.key?e.preventDefault():"ArrowDown"===e.key&&(e.stopPropagation(),this.open=!0,this.dispatch("mon-select:open"))},this.onSlotChange=()=>{this.syncLabelText()},this.syncLabelText=()=>{this.labelText=this.$$$("mon-menu-item")?.filter((e=>e.value===this.value))[0]?.innerText??this.placeholder},this.handleRefChange=e=>{this.anchorRef=e}}get $selected(){return this.$$$("mon-menu-item[selected]")[0]}bindEvents(){this.on("mon-menu:escape",this.onMenuEscape),this.on("keydown",this.onKeyDown),this.collectOff(jo("mousedown",window,(e=>{const t=e.composedPath();e.target instanceof Node&&!t.includes(this)&&this.onClickOutside()}),{capture:!0,passive:!0}))}updated(e){e.has("value")&&this.syncLabelText(),this.open&&!1===e.get("open")&&window.requestAnimationFrame((()=>{const e=this.$$$("mon-menu-item")?.find((e=>e.value===this.value));e?.scrollIntoView({behavior:"instant",block:"nearest"})}))}renderTrigger(){return Ho.qy`
    ...
    `}renderMenu(){return this.open?Ho.qy`
        ...
        ></slot>`}render(){return Ho.qy`${this.renderTrigger()}${this.renderMenu()}`}};tl.styles=el,(0,_o.Cg)([(0,qo.MZ)({type:String,reflect:!0})],tl.prototype,"name",void 0),(0,_o.Cg)([(0,qo.MZ)({type:String})],tl.prototype,"value",void 0),(0,_o.Cg)([(0,qo.MZ)({type:String})],tl.prototype,"popoverPlacement",void 0),(0,_o.Cg)([(0,qo.MZ)()],tl.prototype,"placeholder",void 0),(0,_o.Cg)([(0,qo.wk)()],tl.prototype,"open",void 0),(0,_o.Cg)([(0,qo.wk)()],tl.prototype,"labelText",void 0),(0,_o.Cg)([(0,qo.wk)()],tl.prototype,"anchorRef",void 0),(0,_o.Cg)([(0,qo.wk)()],tl.prototype,"scrollBarWidth",void 0),tl=(0,_o.Cg)([(0,qo.EM)("mon-select")],tl);const al=Ho.AH`
  *,
  *:before,
  *:after {
    box-sizing: border-box;
...
`;let il=class extends Go{constructor(){super(...arguments),this.focusedByClick=!1,this.animationDuration=250}toggleSwitch(e){!0===e?this.toggle?.classList.add("active"):!1===e?this.toggle?.classList.remove("active"):this.toggle?.classList.toggle("active")}handleClick(){this.focusedByClick=!0,this.checkboxes[0].checked=!this.checkboxes[0].checked,this.checkboxes[0].dispatchEvent(new Event("change")),setTimeout((()=>{this.focusedByClick=!1}))}handleFocus(){setTimeout((()=>{!1===this.focusedByClick&&this.toggleVisibleFocus(!0)}))}handleBlur(){this.toggleVisibleFocus(!1)}toggleVisibleFocus(e){!0===e?this.toggle.classList.add("in-focus"):this.toggle.classList.remove("in-focus")}handleCheckboxChange(e){const t=e.target;this.toggleSwitch(t.checked)}handleKeydown(e){"Enter"!==e.key&&" "!==e.key||(e.preventDefault(),this.handleClick())}async connectedCallback(){super.connectedCallback(),await this.updateComplete,this.checkboxes.forEach((e=>{this.toggleSwitch(e.checked),e.style.left="0",e.style.opacity="0.01",e.style.outline="none !important",e.style.position="absolute",e.style.top="0",e.addEventListener("focus",this.handleFocus.bind(this)),e.addEventListener("blur",this.handleBlur.bind(this)),e.addEventListener("change",this.handleCheckboxChange.bind(this)),e.addEventListener("keydown",this.handleKeydown.bind(this))}))}render(){return Ho.qy`
    ...
    `}};il.styles=al,(0,_o.Cg)([(0,qo.P)(".toggle")],il.prototype,"toggle",void 0),(0,_o.Cg)([(0,qo.P)(".control")],il.prototype,"control",void 0),(0,_o.Cg)([(0,qo.KN)({selector:'input[type="checkbox"]'})],il.prototype,"checkboxes",void 0),(0,_o.Cg)([(0,qo.wk)()],il.prototype,"focusedByClick",void 0),(0,_o.Cg)([(0,qo.MZ)({type:Number})],il.prototype,"animationDuration",void 0),il=(0,_o.Cg)([(0,qo.EM)("mon-toggle")],il);const rl=(e,t)=>{const a=t.cssText,i=new WeakSet;return t=>{const r=t.getRootNode();if(!i.has(r)){i.add(r);const t=(r instanceof ShadowRoot?r.ownerDocument:r instanceof Document?r:document).createElement("style");t.setAttribute("data-svelte-lit-styles",e),t.textContent=a,r.appendChild(t)}}},ol=Ho.AH`
  &[data-flex='1'] {
...
`),i.Dn('<svg viewBox="0 0 100 100" data-element="button-spinner"><circle data-element="spinner-circle" cx="50%" cy="50%" r="45%" stroke-width="12.5%" pathLength="1"></circle><circle data-element="spinner-progress" cx="50%" cy="50%" r="45%" stroke-width="12.5%" pathLength="1"></circle></svg>'),i.vs('<span data-element="button-content"><!></span> <!>',1),i.vs('<a arc-button=""><!></a>'),i.vs('<button arc-button=""><!></button>');const pl=Ho.AH`
